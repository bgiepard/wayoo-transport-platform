          ...
          <div className="flex items-center space-x-6">
            {isPassenger && (
              <Link
                ...
                className="text-white hover:text-[#ffc428] font-medium transition-colors relative inline-flex items-center pr-8"
              >
                Moje Zapytania
                {newOffersCount > 0 && (
                  <span className="ml-2 bg-[#ffc428] text-[#215387] text-xs font-bold rounded-full h-5 min-w-[20px] px-1.5 flex items-center justify-center animate-pulse">
                    {newOffersCount}
                  </span>
                )}
              </Link>
