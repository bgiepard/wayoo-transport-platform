            ...
            <div className="max-w-5xl mx-auto mt-12">
              <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-2xl p-8">
                <div className="grid md:grid-cols-2 gap-4 mb-4">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        required
                        className="w-full pl-14 pr-6 py-4 text-lg border-2 border-gray-300 rounded-xl focus:ring-2 focus:ring-[#ffc428] focus:border-[#ffc428] transition-all"
                      />
                    </div>
                  </div>
                  ...
                  {/* Data powrotu (opcjonalna) */}
                  <div>
                    <label className="block text-sm font-semibold text-gray-700 mb-2">
                      Data powrotu <span className="text-gray-400 font-normal">(opcjonalnie)</span>
                    </label>
                    <div className="relative">
                      <div className="absolute left-4 top-1/2 -translate-y-1/2 text-[#ffc428]">
                        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <input
                        ...
                        onChange={handleChange}
                        placeholder="Data powrotu (opcjonalnie)"
                        className="w-full pl-14 pr-6 py-4 text-lg border-2 border-gray-300 rounded-xl focus:ring-2 focus:ring-[#ffc428] focus:border-[#ffc428] transition-all"
                      />
                    </div>
                  </div>
                  ...
                  <div className="flex items-end">
                    <button
                      type="submit"
                      className="w-full px-6 py-4 text-lg bg-[#ffc428] text-[#215387] rounded-xl hover:bg-[#f5b920] transition-all font-bold shadow-lg hover:shadow-xl hover:scale-105 flex items-center justify-center gap-2"
                    >
                      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
